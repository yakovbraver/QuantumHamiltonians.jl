...
@testset "Fourier-block x-space preconditioner" begin
    ...
    prec = QuantumHamiltonians.FourierBlockPreconditioner(xh)
    ...
    gauge_prec = QuantumHamiltonians.FourierBlockPreconditioner(xh_gauge)
    ...
    variable_prec = QuantumHamiltonians.FourierBlockPreconditioner(xh_variable_gauge)
    ...
    for (basis, M) in ((:sin, 3), (:cos, 4))
        ...
        real_prec = QuantumHamiltonians.FourierBlockPreconditioner(xh_real)
