...
@time xh = XSpaceHamiltonian{:dense}([xlimits, ylimits], 𝑈; isperiodic=false, M);
xh = XSpaceHamiltonian{:dense}([xlimits, ylimits], 𝑈; isperiodic=false, M)

# Or we can solve periodic case. Potential is even, so we set `𝑈_iseven`, yielding a real Hamiltonian
xh = XSpaceHamiltonian{:dense}([xlimits, ylimits], 𝑈; isperiodic=true, M, 𝑈_iseven=true)
...
M = 35
xh = XSpaceHamiltonian{:dense}([xlimits, ylimits], 𝑈; isperiodic=true, M, 𝑈_iseven=true) # M = 30, ncells = 5: 9.6 s.
...
@time xh = XSpaceHamiltonian{:dense}([xlimits, ylimits], 𝑈, [𝐴_x, 𝐴_y]; isperiodic=false, M);
...
@time xh = XSpaceHamiltonian{:dense}([xlimits, ylimits], 𝑈, [𝐴_x, 𝐴_y]; isperiodic=true, M, 𝑈_iseven=true); # M = 50, Float64: 56 s construct + 10 s diagonalise
